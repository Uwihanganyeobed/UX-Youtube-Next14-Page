    ...
    <header className="flex justify-between items-center fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-50 h-14">
      ...
      <div className="flex items-center flex-grow max-w-lg mx-6">
        <input 
          type="text" 
          placeholder="Search"
          className="w-full h-9 border border-gray-300 rounded-l px-4 shadow-inner"
        />
      ...
      <div className="flex items-center space-x-6 pr-6">
        <div className="relative group">
          <FaVideo className="h-7 text-gray-700" />
        ...
        <FaTh className="h-7 text-gray-700" />
        <div className="relative">
          <FaBell className="h-7 text-gray-700" />
          <span className="absolute top-0 right-0 bg-red-500 text-white text-xs rounded-full px-1">3</span>
        </div>
        <img src="https://i.imgur.com/8h8FIqj.jpg" alt="User Profile" className="h-8 rounded-xl " />
      </div>
    </header>
  );
};
